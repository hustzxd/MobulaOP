...
#ifndef _GLIBCXX_FUNCTIONAL_GCC_4_9
#define _GLIBCXX_FUNCTIONAL_GCC_4_9 1
...
namespace std_gcc4_9 _GLIBCXX_VISIBILITY(default) {
  using namespace std;
  ...
  class reference_wrapper
   ...
   public:
    ...
    reference_wrapper& operator=(
        const reference_wrapper<_Tp>& __inref) noexcept {
      _M_data = __inref._M_data;
      return *this;
    }
  ...
  class _Mem_fn<_Res _Class::*> {
    ...
    auto _M_call(_Tp&& __object, _Up* const*) const noexcept
        -> decltype((*std::forward<_Tp>(__object)).*
   ...
   public:
    ...
    auto operator()(_Tp&& __unknown) const noexcept(
        noexcept(std::declval<_Mem_fn*>()->_M_call(std::forward<_Tp>(__unknown),
                                                   &__unknown)))
  ...
  class _Bind<_Functor(_Bound_args...)> : public _Weak_result_type<_Functor> {
   ...
   public:
    ...
    template <typename... _Args,
              typename _Result =
                  decltype(std::declval<typename enable_if<
                               (sizeof...(_Args) >= 0),
    ...
    template <
        ...
        typename _Result = decltype(
            std::declval<
                typename enable_if<(sizeof...(_Args) >= 0),
  ...
  struct _Bind_simple<_Callable(_Args...)> {
   ...
   private:
    ...
    typename result_of<_Callable(_Args...)>::type _M_invoke(
  ...
  _GLIBCXX_END_NAMESPACE_VERSION
}  // namespace std_gcc4_9_GLIBCXX_VISIBILITY(default)
